...
export const translations = {
    en: {
        ...
        // Toast areas (notification source) + messages
        toastDevice: 'Device',
        toastWireless: 'Wireless',
        toastInstall: 'Install',
        toastApp: 'Device Apps',
        toastScreen: 'Device Screen',
        toastFile: 'Device Files',
        toastLogcat: 'Logcat',
        toastTerminal: 'Terminal',
        toastUpdate: 'Check for updates',
        toastInput: 'Input',
        ...
        msgFolderOpened: 'Folder opened',
        msgEnabled: 'Enabled',
        msgDisabled: 'Disabled',
        msgMirrorOpened: 'Mirror window opened',
        msgMirrorCreateFailed: 'Failed to create window',
        msgMirrorOpenFailed: 'Failed to open mirror window',
        msgBufferCleared: 'Buffer cleared',
        msgLogsExported: 'Logs exported',
        msgExportLogsFailed: 'Failed to export logs',
        msgHistoryExported: 'History exported',
        msgExportHistoryFailed: 'Failed to export history',
        msgPathUpdated: 'Save path updated',
        msgNotifications: 'Notifications',
        msgAskBeforeSave: 'Ask before saving',
        msgBrowserDebug: 'Browser unavailable in debug mode',
        msgBrowserUnavailable: 'Browser feature not available',
        msgDownloadingUpdate: 'Downloading update',
        msgUpdateInstalled: 'Installed - restart the app',
        msgUpdateCheckFailed: 'Update check failed',
        msgUpdateCheckFailedConn: 'Check failed - verify your connection',
        msgUpdateInstallFailed: 'Failed to install update',
        ...
        updaterDevMode: 'Auto-updater is not supported in development mode.',
        sortBy: 'Sort By',
    ...
    vi: {
        ...
        // Toast areas (notification source) + messages
        toastDevice: 'Thiết bị',
        toastWireless: 'Không dây',
        toastInstall: 'Cài APK',
        toastApp: 'Ứng dụng thiết bị',
        toastScreen: 'Màn hình thiết bị',
        toastFile: 'Tệp thiết bị',
        toastLogcat: 'Logcat',
        toastTerminal: 'Terminal',
        toastUpdate: 'Kiểm tra cập nhật',
        toastInput: 'Bàn phím',
        msgConnected: 'Đã kết nối',
        msgDisconnected: 'Đã ngắt kết nối',
        msgUninstalled: 'Đã gỡ cài đặt',
        msgUploaded: 'Đã tải lên',
        msgDownloaded: 'Đã tải xuống',
        msgDeleted: 'Đã xóa',
        msgFolderCreated: 'Đã tạo thư mục',
        msgFolderOpened: 'Đã mở thư mục',
        msgEnabled: 'Đã bật',
        msgDisabled: 'Đã tắt',
        msgMirrorOpened: 'Đã mở cửa sổ phản chiếu',
        msgMirrorCreateFailed: 'Tạo cửa sổ thất bại',
        msgMirrorOpenFailed: 'Mở cửa sổ phản chiếu thất bại',
        msgBufferCleared: 'Đã xóa bộ đệm',
        msgLogsExported: 'Đã xuất log',
        msgExportLogsFailed: 'Xuất log thất bại',
        msgHistoryExported: 'Đã xuất lịch sử',
        msgExportHistoryFailed: 'Xuất lịch sử thất bại',
        msgPathUpdated: 'Đã cập nhật đường dẫn lưu',
        msgNotifications: 'Thông báo',
        msgAskBeforeSave: 'Hỏi trước khi lưu',
        msgBrowserDebug: 'Trình duyệt không khả dụng ở chế độ gỡ lỗi',
        msgBrowserUnavailable: 'Tính năng trình duyệt không khả dụng',
        msgDownloadingUpdate: 'Đang tải cập nhật',
        msgUpdateInstalled: 'Đã cài - khởi động lại ứng dụng',
        msgUpdateCheckFailed: 'Kiểm tra cập nhật thất bại',
        msgUpdateCheckFailedConn: 'Kiểm tra thất bại - kiểm tra kết nối mạng',
        msgUpdateInstallFailed: 'Cài cập nhật thất bại',
        msgCompleted: 'Hoàn tất',
        ...
        updaterDevMode: 'Tính năng cập nhật tự động không hỗ trợ ở chế độ tauri dev.',
        sortBy: 'Sắp xếp theo',
        sortNameAsc: 'Tên (A-Z)',
        sortNameDesc: 'Tên (Z-A)',
        sortDateDesc: 'Ngày sửa đổi (Mới nhất)',
        sortDateAsc: 'Ngày sửa đổi (Cũ nhất)',
